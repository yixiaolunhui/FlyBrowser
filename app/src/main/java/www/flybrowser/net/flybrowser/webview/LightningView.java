...
import www.flybrowser.net.flybrowser.app.BrowserApp;
import www.flybrowser.net.flybrowser.constant.Constants;
import www.flybrowser.net.flybrowser.constant.StartPage;
import www.flybrowser.net.flybrowser.controller.BrowserController;
import www.flybrowser.net.flybrowser.download.LightningDownloadListener;
import www.flybrowser.net.flybrowser.preference.PreferenceManager;
import www.flybrowser.net.flybrowser.utils.AdBlock;
import www.flybrowser.net.flybrowser.utils.IntentUtils;
import www.flybrowser.net.flybrowser.utils.PermissionsManager;
...
public class LightningView {
    ...
    public class LightningWebClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (API >= Build.VERSION_CODES.KITKAT && mInvertPage) {
        ...
        public void onScaleChanged(final WebView view, final float oldScale, final float newScale) {
            if (view.isShown() && mTextReflow && API >= Build.VERSION_CODES.KITKAT) {
                if (mIsRunning)
                    return;
    ...
    public class Title {
        ...
        public Title(Context context, boolean darkTheme) {
            mDefaultIcon = ThemeUtils.getThemedBitmap(context, R.mipmap.ic_webpage, darkTheme);
